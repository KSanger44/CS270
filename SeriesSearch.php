...
<body>
    ...
    <div class="main">
        <h2>Search for SERIES containing...</h2>
        <div class="search">
        ...
        if(isset($_GET['search'])){
            ...
            $sql = "select * from SERIES, ISSUES where SERIES.SeriesID = ISSUES.SeriesID and SeriesName like '%$querySeries%'";
            ...
            echo "<p>No results found for '" . $querySeries . "'</p>";
        }
